...
trait ClassPropertiesTestTrait
{
    ...
    {
        // #0
        yield 'ClassPropertiesTestTrait.php:'.__LINE__ => [
            'args'   => [],
            'expect' => [],
        ];
    ...
    public function testValues(array $args, $expect): void
    {
        ...
        self::assertSame(ActualClassProperties::class === $class, $object->actual());
    }

    // @codeCoverageIgnoreStart
    public static function provTag(): iterable
    {
        $family = __NAMESPACE__.'\ClassProperties';
    ...
    public function testCreateActualClassProperties(): void
    {
        $class = self::getValuesClass();
        $object = new $class([]);
