...
/**
 * @small
 * @covers \Tailors\PHPUnit\Properties\RecursivePropertiesSelector
 *
    ...
    public static function provSelectProperties(): array
    {
        ...
        return [
            'RecursivePropertiesSelectorTest.php:'.__LINE__ => [
                'selector' => self::createExpectedObjectProperties([]),
                'subject'  => new class() {
                },
                'expect' => [
            ...
            'RecursivePropertiesSelectorTest.php:'.__LINE__ => [
                'selector' => self::createExpectedObjectProperties([
                    'foo' => 'e:FOO',
                    'bar' => self::createExpectedObjectProperties([
                        'baz' => 'e:BAZ',
                    ]),
                ]),
                'subject' => new class() {
            ...
            'RecursivePropertiesSelectorTest.php:'.__LINE__ => [
                'selector' => self::createExpectedClassProperties([]),
                'subject'  => new class() {
                },
                'expect' => [
                    self::UNIQUE_TAG => true,
            ...
            'RecursivePropertiesSelectorTest.php:'.__LINE__ => [
                'selector' => self::createExpectedObjectProperties([
                    'foo'   => 'e:FOO',
                    'bar()' => self::createExpectedClassProperties([
                        'baz' => 'e:BAZ',
                    ]),
                ]),
