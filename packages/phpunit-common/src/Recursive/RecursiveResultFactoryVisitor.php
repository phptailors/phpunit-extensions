...
final class RecursiveResultFactoryVisitor implements RecursiveVisitorInterface
{
     ...
     * @param mixed $subject
     */
    public function __construct(ResultFactoryInterface $resultFactory, $subject)
    {
    ...
    private function getResultFactory(object $node): ResultFactoryInterface
    {
        if ($node instanceof ResultFactoryWrapperInterface) {
            return $node->getResultFactory();
        }
