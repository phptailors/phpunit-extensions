    ...
    public static function provWalk(): iterable
    {
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect'  => [
                ...
                ['func' => 'makeStackItem', 'node' => $v03, 'key' => 'foo', 'path' => []],
                ['func' => 'visit', 'node' => $v03['foo'], 'path' => ['foo']],
                ['func' => 'freeStackItem', 'node' => $v03, 'key' => 'foo', 'path' => []],
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect'  => [
                ...
                ['func' => 'makeStackItem', 'node' => $v04, 'key' => 'foo', 'path' => []],
                ['func' => 'visit', 'node' => $v04['foo'], 'path' => ['foo']],
                ['func' => 'freeStackItem', 'node' => $v04, 'key' => 'foo', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v04, 'key' => 'bar', 'path' => []],
                ['func' => 'visit', 'node' => $v04['bar'], 'path' => ['bar']],
                ['func' => 'freeStackItem', 'node' => $v04, 'key' => 'bar', 'path' => []],
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect'  => [
                ...
                ['func' => 'makeStackItem', 'node' => $v05, 'key' => 'bar', 'path' => []],
                ['func' => 'visit', 'node' => $v05['bar'], 'path' => ['bar']],
                ['func' => 'freeStackItem', 'node' => $v05, 'key' => 'bar', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v05, 'key' => 'foo', 'path' => []],
                ['func' => 'visit', 'node' => $v05['foo'], 'path' => ['foo']],
                ['func' => 'freeStackItem', 'node' => $v05, 'key' => 'foo', 'path' => []],
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect'  => [
                ...
                ['func' => 'makeStackItem', 'node' => $v06, 'key' => 'foo', 'path' => []],
                ['func' => 'visit', 'node' => $v06['foo'], 'path' => ['foo']],
                ['func' => 'freeStackItem', 'node' => $v06, 'key' => 'foo', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v06, 'key' => 'bar', 'path' => []],
                ['func' => 'visit', 'node' => $v06['bar'], 'path' => ['bar']],
                ['func' => 'freeStackItem', 'node' => $v06, 'key' => 'bar', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v06, 'key' => 'baz', 'path' => []],
                ['func' => 'enter', 'node' => $v06['baz'], 'path' => ['baz']],
                ['func' => 'makeStackItem', 'node' => $v06['baz'], 'key' => 'cor', 'path' => ['baz']],
                ['func' => 'visit', 'node' => $v06['baz']['cor'], 'path' => ['baz', 'cor']],
                ['func' => 'freeStackItem', 'node' => $v06['baz'], 'key' => 'cor', 'path' => ['baz']],
                ['func' => 'makeStackItem', 'node' => $v06['baz'], 'key' => 'qux', 'path' => ['baz']],
                ['func' => 'cycle', 'node' => $v06['baz']['qux'], 'path' => ['baz', 'qux']],
                ['func' => 'freeStackItem', 'node' => $v06['baz'], 'key' => 'qux', 'path' => ['baz']],
                ['func' => 'leave', 'node' => $v06['baz'], 'path' => ['baz']],
                ['func' => 'freeStackItem', 'node' => $v06, 'key' => 'baz', 'path' => []],
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect'  => [
                ...
                ['func' => 'makeStackItem', 'node' => $v07, 'key' => 'foo', 'path' => []],
                ['func' => 'visit', 'node' => $v07['foo'], 'path' => ['foo']],
                ['func' => 'freeStackItem', 'node' => $v07, 'key' => 'foo', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v07, 'key' => 'baz', 'path' => []],
                ['func' => 'enter', 'node' => $v07['baz'], 'path' => ['baz']],
                ['func' => 'makeStackItem', 'node' => $v07['baz'], 'key' => 'qux', 'path' => ['baz']],
                ['func' => 'cycle', 'node' => $v07['baz']['qux'], 'path' => ['baz', 'qux']],
                ['func' => 'freeStackItem', 'node' => $v07['baz'], 'key' => 'qux', 'path' => ['baz']],
                ['func' => 'makeStackItem', 'node' => $v07['baz'], 'key' => 'cor', 'path' => ['baz']],
                ['func' => 'visit', 'node' => $v07['baz']['cor'], 'path' => ['baz', 'cor']],
                ['func' => 'freeStackItem', 'node' => $v07['baz'], 'key' => 'cor', 'path' => ['baz']],
                ['func' => 'leave', 'node' => $v07['baz'], 'path' => ['baz']],
                ['func' => 'freeStackItem', 'node' => $v07, 'key' => 'baz', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v07, 'key' => 'bar', 'path' => []],
                ['func' => 'visit', 'node' => $v07['bar'], 'path' => ['bar']],
                ['func' => 'freeStackItem', 'node' => $v07, 'key' => 'bar', 'path' => []],
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect' => [
                ...
                ['func' => 'freeStackItem', 'node' => $v08, 'key' => 'foo', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v08, 'key' => 'baz', 'path' => []],
                ['func' => 'enter', 'node' => $v08['baz'], 'path' => ['baz']],
                ['func' => 'makeStackItem', 'node' => $v08['baz'], 'key' => 'qux', 'path' => ['baz']],
                ['func' => 'cycle', 'node' => $v08, 'path' => ['baz', 'qux']],
                ['func' => 'enter', 'node' => $v08, 'path' => ['baz', 'qux']],
                ['func' => 'makeStackItem', 'node' => $v08['baz']['qux'], 'key' => 'foo', 'path' => ['baz', 'qux']],
                ['func' => 'visit', 'node' => $v08['foo'], 'path' => ['baz', 'qux', 'foo']],
                ['func' => 'freeStackItem', 'node' => $v08['baz']['qux'], 'key' => 'foo', 'path' => ['baz', 'qux']],
                ['func' => 'makeStackItem', 'node' => $v08['baz']['qux'], 'key' => 'baz', 'path' => ['baz', 'qux']],
                ...
                ['func' => 'freeStackItem', 'node' => $v08['baz']['qux'], 'key' => 'baz', 'path' => ['baz', 'qux']],
                ['func' => 'makeStackItem', 'node' => $v08['baz']['qux'], 'key' => 'bar', 'path' => ['baz', 'qux']],
                ['func' => 'visit', 'node' => $v08['bar'], 'path' => ['baz', 'qux', 'bar']],
                ['func' => 'freeStackItem', 'node' => $v08['baz']['qux'], 'key' => 'bar', 'path' => ['baz', 'qux']],
                ['func' => 'leave', 'node' => $v08, 'path' => ['baz', 'qux']],
                ['func' => 'freeStackItem', 'node' => $v08['baz'], 'key' => 'qux', 'path' => ['baz']],
                ['func' => 'makeStackItem', 'node' => $v08['baz'], 'key' => 'cor', 'path' => ['baz']],
                ['func' => 'visit', 'node' => $v08['baz']['cor'], 'path' => ['baz', 'cor']],
                ['func' => 'freeStackItem', 'node' => $v08['baz'], 'key' => 'cor', 'path' => ['baz']],
                ['func' => 'leave', 'node' => $v08['baz'], 'path' => ['baz']],
                ['func' => 'freeStackItem', 'node' => $v08, 'key' => 'baz', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v08, 'key' => 'bar', 'path' => []],
                ['func' => 'visit', 'node' => $v08['bar'], 'path' => ['bar']],
                ['func' => 'freeStackItem', 'node' => $v08, 'key' => 'bar', 'path' => []],
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect'  => [
                ...
                ['func' => 'freeStackItem', 'node' => $v09, 'key' => 'foo', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v09, 'key' => 'bar', 'path' => []],
                ['func' => 'enter', 'node' => $v09['bar'], 'path' => ['bar']],
                ['func' => 'visit', 'node' => $v09['bar'], 'path' => ['bar']],
                ['func' => 'leave', 'node' => $v09['bar'], 'path' => ['bar']],
                ['func' => 'freeStackItem', 'node' => $v09, 'key' => 'bar', 'path' => []],
                ['func' => 'leave', 'node' => $v09, 'path' => []],
            ],
        ];
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect'  => [
                ...
                ['func' => 'makeStackItem', 'node' => $v09, 'key' => 'foo', 'path' => []],
                ['func' => 'enter', 'node' => $v09['foo'], 'path' => ['foo']],
                ['func' => 'makeStackItem', 'node' => $v09['foo'], 'key' => 'baz', 'path' => ['foo']],
                ['func' => 'visit', 'node' => $v09['foo']['baz'], 'path' => ['foo', 'baz']],
                ['func' => 'freeStackItem', 'node' => $v09['foo'], 'key' => 'baz', 'path' => ['foo']],
                ['func' => 'leave', 'node' => $v09['foo'], 'path' => ['foo']],
                ['func' => 'freeStackItem', 'node' => $v09, 'key' => 'foo', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v09, 'key' => 'bar', 'path' => []],
                ['func' => 'enter', 'node' => $v09['bar'], 'path' => ['bar']],
                ['func' => 'makeStackItem', 'node' => $v09['bar'], 'key' => 'qux', 'path' => ['bar']],
                ['func' => 'visit', 'node' => $v09['bar']['qux'], 'path' => ['bar', 'qux']],
                ['func' => 'freeStackItem', 'node' => $v09['bar'], 'key' => 'qux', 'path' => ['bar']],
                ['func' => 'leave', 'node' => $v09['bar'], 'path' => ['bar']],
                ['func' => 'freeStackItem', 'node' => $v09, 'key' => 'bar', 'path' => []],
                ['func' => 'leave', 'node' => $v09, 'path' => []],
            ],
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect'  => [
                ...
                ['func' => 'makeStackItem', 'node' => $v10['foo'], 'key' => 'baz', 'path' => ['foo']],
                ['func' => 'visit', 'node' => $v10['foo']['baz'], 'path' => ['foo', 'baz']],
                ['func' => 'freeStackItem', 'node' => $v10['foo'], 'key' => 'baz', 'path' => ['foo']],
                ['func' => 'makeStackItem', 'node' => $v10['foo'], 'key' => 'cor', 'path' => ['foo']],
                ['func' => 'enter', 'node' => $v10['foo']['cor'], 'path' => ['foo', 'cor']],
                ['func' => 'visit', 'node' => $v10['foo']['cor'], 'path' => ['foo', 'cor']],
                ['func' => 'leave', 'node' => $v10['foo']['cor'], 'path' => ['foo', 'cor']],
                ['func' => 'freeStackItem', 'node' => $v10['foo'], 'key' => 'cor', 'path' => ['foo']],
                ['func' => 'leave', 'node' => $v10['foo'], 'path' => ['foo']],
                ['func' => 'freeStackItem', 'node' => $v10, 'key' => 'foo', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v10, 'key' => 'bar', 'path' => []],
                ['func' => 'enter', 'node' => $v10['bar'], 'path' => ['bar']],
                ['func' => 'makeStackItem', 'node' => $v10['bar'], 'key' => 'qux', 'path' => ['bar']],
                ['func' => 'visit', 'node' => $v10['bar']['qux'], 'path' => ['bar', 'qux']],
                ['func' => 'freeStackItem', 'node' => $v10['bar'], 'key' => 'qux', 'path' => ['bar']],
                ['func' => 'makeStackItem', 'node' => $v10['bar'], 'key' => 'cor', 'path' => ['bar']],
                ['func' => 'enter', 'node' => $v10['bar']['cor'], 'path' => ['bar', 'cor']],
                ['func' => 'visit', 'node' => $v10['bar']['cor'], 'path' => ['bar', 'cor']],
                ['func' => 'leave', 'node' => $v10['bar']['cor'], 'path' => ['bar', 'cor']],
                ['func' => 'freeStackItem', 'node' => $v10['bar'], 'key' => 'cor', 'path' => ['bar']],
                ['func' => 'leave', 'node' => $v10['bar'], 'path' => ['bar']],
                ['func' => 'freeStackItem', 'node' => $v10, 'key' => 'bar', 'path' => []],
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect'  => [
                ...
                ['func' => 'makeStackItem', 'node' => $v11, 'key' => 'foo', 'path' => []],
                ['func' => 'enter', 'node' => $v11['foo'], 'path' => ['foo']],
                ['func' => 'makeStackItem', 'node' => $v11['foo'], 'key' => 'baz', 'path' => ['foo']],
                ['func' => 'enter', 'node' => $v11['foo']['baz'], 'path' => ['foo', 'baz']],
                ['func' => 'makeStackItem', 'node' => $v11['foo']['baz'], 'key' => 'cor', 'path' => ['foo', 'baz']],
                ['func' => 'visit', 'node' => $v11['foo']['baz']['cor'], 'path' => ['foo', 'baz', 'cor']],
                ['func' => 'freeStackItem', 'node' => $v11['foo']['baz'], 'key' => 'cor', 'path' => ['foo', 'baz']],
                ['func' => 'leave', 'node' => $v11['foo']['baz'], 'path' => ['foo', 'baz']],
                ['func' => 'freeStackItem', 'node' => $v11['foo'], 'key' => 'baz', 'path' => ['foo']],
                ['func' => 'leave', 'node' => $v11['foo'], 'path' => ['foo']],
                ['func' => 'freeStackItem', 'node' => $v11, 'key' => 'foo', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v11, 'key' => 'bar', 'path' => []],
                ['func' => 'enter', 'node' => $v11['bar'], 'path' => ['bar']],
                ['func' => 'makeStackItem', 'node' => $v11['bar'], 'key' => 'qux', 'path' => ['bar']],
                ['func' => 'enter', 'node' => $v11['bar']['qux'], 'path' => ['bar', 'qux']],
                ['func' => 'makeStackItem', 'node' => $v11['bar']['qux'], 'key' => 'cor', 'path' => ['bar', 'qux']],
                ['func' => 'visit', 'node' => $v11['bar']['qux']['cor'], 'path' => ['bar', 'qux', 'cor']],
                ['func' => 'freeStackItem', 'node' => $v11['bar']['qux'], 'key' => 'cor', 'path' => ['bar', 'qux']],
                ['func' => 'leave', 'node' => $v11['bar']['qux'], 'path' => ['bar', 'qux']],
                ['func' => 'freeStackItem', 'node' => $v11['bar'], 'key' => 'qux', 'path' => ['bar']],
                ['func' => 'leave', 'node' => $v11['bar'], 'path' => ['bar']],
                ['func' => 'freeStackItem', 'node' => $v11, 'key' => 'bar', 'path' => []],
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect'  => [
                ...
                ['func' => 'makeStackItem', 'node' => $v12, 'key' => 'foo', 'path' => []],
                ['func' => 'enter', 'node' => $v12['foo'], 'path' => ['foo']],
                ['func' => 'makeStackItem', 'node' => $v12['foo'], 'key' => 'baz', 'path' => ['foo']],
                ['func' => 'enter', 'node' => $v12baz, 'path' => ['foo', 'baz']],
                ['func' => 'makeStackItem', 'node' => $v12baz, 'key' => 'cor', 'path' => ['foo', 'baz']],
                ['func' => 'visit', 'node' => $v12baz['cor'], 'path' => ['foo', 'baz', 'cor']],
                ['func' => 'freeStackItem', 'node' => $v12baz, 'key' => 'cor', 'path' => ['foo', 'baz']],
                ['func' => 'leave', 'node' => $v12baz, 'path' => ['foo', 'baz']],
                ['func' => 'freeStackItem', 'node' => $v12['foo'], 'key' => 'baz', 'path' => ['foo']],
                ['func' => 'leave', 'node' => $v12['foo'], 'path' => ['foo']],
                ['func' => 'freeStackItem', 'node' => $v12, 'key' => 'foo', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v12, 'key' => 'bar', 'path' => []],
                ['func' => 'enter', 'node' => $v12['bar'], 'path' => ['bar']],
                ['func' => 'makeStackItem', 'node' => $v12['bar'], 'key' => 'qux', 'path' => ['bar']],
                ['func' => 'enter', 'node' => $v12qux, 'path' => ['bar', 'qux']],
                ['func' => 'makeStackItem', 'node' => $v12qux, 'key' => 'cor', 'path' => ['bar', 'qux']],
                ['func' => 'visit', 'node' => $v12qux['cor'], 'path' => ['bar', 'qux', 'cor']],
                ['func' => 'freeStackItem', 'node' => $v12qux, 'key' => 'cor', 'path' => ['bar', 'qux']],
                ['func' => 'leave', 'node' => $v12qux, 'path' => ['bar', 'qux']],
                ['func' => 'freeStackItem', 'node' => $v12['bar'], 'key' => 'qux', 'path' => ['bar']],
                ['func' => 'leave', 'node' => $v12['bar'], 'path' => ['bar']],
                ['func' => 'freeStackItem', 'node' => $v12, 'key' => 'bar', 'path' => []],
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect'  => [
                ...
                ['func' => 'makeStackItem', 'node' => $v13, 'key' => 'foo', 'path' => []],
                ['func' => 'visit', 'node' => $v13['foo'], 'path' => ['foo']],
                ['func' => 'freeStackItem', 'node' => $v13, 'key' => 'foo', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v13, 'key' => 'bar', 'path' => []],
                ['func' => 'visit', 'node' => $v13['bar'], 'path' => ['bar']],
                ['func' => 'freeStackItem', 'node' => $v13, 'key' => 'bar', 'path' => []],
                ['func' => 'makeStackItem', 'node' => $v13, 'key' => 'baz', 'path' => []],
                ['func' => 'enter', 'node' => $v13['baz'], 'path' => ['baz']],
                ['func' => 'makeStackItem', 'node' => $v13['baz'], 'key' => 'cor', 'path' => ['baz']],
                ['func' => 'visit', 'node' => $v13['baz']['cor'], 'path' => ['baz', 'cor']],
                ['func' => 'freeStackItem', 'node' => $v13['baz'], 'key' => 'cor', 'path' => ['baz']],
                ['func' => 'makeStackItem', 'node' => $v13['baz'], 'key' => 'qux', 'path' => ['baz']],
                ['func' => 'enter', 'node' => $v13['baz']['qux'], 'path' => ['baz', 'qux']],
                ['func' => 'makeStackItem', 'node' => $v13['baz']['qux'], 'key' => 'zot', 'path' => ['baz', 'qux']],
                ['func' => 'cycle', 'node' => $v13['baz']['qux']['zot'], 'path' => ['baz', 'qux', 'zot']],
                ['func' => 'freeStackItem', 'node' => $v13['baz']['qux'], 'key' => 'zot', 'path' => ['baz', 'qux']],
                ['func' => 'leave', 'node' => $v13['baz']['qux'], 'path' => ['baz', 'qux']],
                ['func' => 'freeStackItem', 'node' => $v13['baz'], 'key' => 'qux', 'path' => ['baz']],
                ['func' => 'leave', 'node' => $v13['baz'], 'path' => ['baz']],
                ['func' => 'freeStackItem', 'node' => $v13, 'key' => 'baz', 'path' => []],
