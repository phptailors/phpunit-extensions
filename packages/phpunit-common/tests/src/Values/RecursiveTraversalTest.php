    ...
    public static function provWalk(): iterable
    {
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect' => [
                ...
                ['func' => 'freeStackItem', 'path' => ['baz', 'qux']],
        ...
        yield 'RecursiveTraversalTest.php:'.__LINE__ => [
            ...
            'expect'  => [
                ...
                ['func' => 'freeStackItem', 'path' => ['foo', 'baz']],
                ...
                ['func' => 'freeStackItem', 'path' => ['bar', 'qux']],
